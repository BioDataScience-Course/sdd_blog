...
description: |
  Bienvenue sur ce site web qui va te permettre de créer facilement un blog scientifique!
...
Savais-tu qu'un fichier au format Rmarkdown ne servait pas uniquement à compiler un rapport au format html, pdf ou encore word. 
...
**Rends-toi dans la section [Articles](http://biodatascience-course.sciviews.org/sdd_blog/articles.html) pour en apprendre d'avantages sur les blog scientifiques.**
